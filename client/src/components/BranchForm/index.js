...
class BranchForm extends React.Component {
	...
	renderCheckbox = ({ input, label, type, meta, rest }) => {
		...
		return (
			<div className={className}>
				<label> <a onClick={() => this.setState({ isShowingModal: true })} style={{ cursor: 'hand' }}> {label}</a></label>
			...
			<Modal onClose={() => this.setState({ isShowingModal: false })}>
				...
				>
					...
					<div className="token-modal__token-list">
						...
						The Fund shall be a charitable Donor-Advised Fund, as defined in Section 4966 of the Internal Revenue Code of 1986, as amended (“Code”) and the Fund shall be
						administered under and subject to the Federation’s policies, including the Federation's Donor-Advised Fund Policies and Procedures as may be amended from time to
						time (the “Fund Policies”).
						The date on which the initial contribution is received by the Federation constitutes the "establish date" of the Fund.
						The Fund shall consist of the property listed in the Initial Contribution section of this document (the “Property”), and such other property as may, from time to time, be
						...
						The Fund shall be the property of the Federation; it shall not be deemed a trust fund held by it in a trustee capacity. The Federation in its normal corporate capacity shall
						have the ultimate ownership, authority and control over all property in the Fund, and the income derived therefrom, for the charitable, educational and religious purposes of
						the Federation.
						The assets of the Fund shall be used for charitable, educational or religious purposes within the exempt purposes of the Federation, either directly or by contributions to
						other organizations for such purposes.
						Distributions from the Fund of the income or principal or both, within the limitations provided for in this agreement, shall be made at such times, in such amounts, in such
						...
						It is intended that the Fund shall be a component part of the Federation's, and not a separate trust, and that nothing in this Agreement shall affect the status of the
						...
						out the foregoing intention. Reference herein to provisions of the Internal Revenue Code of 1986 shall be deemed references to the corresponding provisions of any future
						Internal Revenue Code.
						Upon the termination, by death or otherwise, of the privilege of a Fund Advisor to make recommendations, the Fund shall cease to be a Donor-Advised Fund but shall
						become a part of the Unrestricted Endowment Fund of the Federation.
						Fees will be assessed to the Fund as follows: 1.0% on the first $3 million; 0.75% on the next $7 million; 0.5% on the next $15 million; 0.25% over $25 million. Fees are
						charged on a quarterly basis, and are based on the average daily value of all cash and non-cash assets held in the fund. Fees are subject to change. Any such changes will
						be communicated to you in writing. $100 minimum fee per year.
						In compliance with the Internal Revenue Code, grants are not permitted to individuals for non-charitable purposes; for political contributions or to support political campaign
						...
						Inactive Funds – If a Fund shows no activity (grants or contributions) for three years or more, the Federation will attempt to contact the Primary Advisor(s), other Fund
						Advisor(s), and/or any Interested Parties. If the Fund remains inactive for another year after this notification, and the Fund is inactive for a total of four years, the Fund may be
						closed and the Fund assets may be distributed according to this agreement.
						Zero and Negative Balance Funds – If a Fund has a zero or negative balance, the Federation will contact the Primary Advisor(s). If the zero or negative balance persists more
						than three months after this contact, the Fund will be closed unless other arrangements are made.
						This Agreement may be executed in one or more counterparts, each of which shall be considered an original, but all of which together shall constitute one and the same
						agreement.
					</div>
					</div>
				</CSSTransitionGroup>
